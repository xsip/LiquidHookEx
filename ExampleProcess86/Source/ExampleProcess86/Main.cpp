#include <ExampleProcess86/Include.h>
#include <ExampleProcess86/IEntity.h>
#include <ExampleProcess86/Helper.h>

#include <Windows.h>
#include <cstdio>

// ============================================================================
//  ExampleProcess86 entry point
//
...
int main() {
    printf("[ExampleProcess86] started (pid=%lu)\n\n", GetCurrentProcessId());
    ...
    while (true) {
        ...
        int vkey = VK_RSHIFT;  // forces mov + push or push imm32
